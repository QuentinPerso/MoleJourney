...
public class DroidGoogleServices implements GameServices{
	...
	@Override
	public void submitScore3(long score) {
		if (isSignedIn() == true){
			Games.Leaderboards.submitScore(gameHelper.getApiClient(), context.getString(R.string.leaderboard_flying_mole), score);
			//context.startActivityForResult(Games.Leaderboards.getLeaderboardIntent(gameHelper.getApiClient(), context.getString(R.string.leaderboard_id)), REQUEST_CODE_UNUSED);
		}
		else{
			signIn();
	...
	@Override
	public void submitScore4(long score) {
		if (isSignedIn() == true){
			Games.Leaderboards.submitScore(gameHelper.getApiClient(), context.getString(R.string.leaderboard_monumental_challenge), score);
			//context.startActivityForResult(Games.Leaderboards.getLeaderboardIntent(gameHelper.getApiClient(), context.getString(R.string.leaderboard_id)), REQUEST_CODE_UNUSED);
		}
		else{
			signIn();
	...
	@Override
	public void submitScore6(long score) {
		// TODO Auto-generated method stub
	...
	public void showScore3() {
		context.startActivityForResult(Games.Leaderboards.getLeaderboardIntent(
				gameHelper.getApiClient(),
				context.getString(R.string.leaderboard_flying_mole))
			, REQUEST_CODE_UNUSED);
	...
	public void showScore4() {
		context.startActivityForResult(Games.Leaderboards.getLeaderboardIntent(
				gameHelper.getApiClient(),
				context.getString(R.string.leaderboard_monumental_challenge))
			, REQUEST_CODE_UNUSED);
